...
- The mark before the date says which, and a press on it turns the card over. On a normal card it is a plain ring in the colour of the column. On a low one it is the same ring in grey with eight spokes around it, a sun. The spokes are the whole of the difference. There is no menu row for this: the mark is the whole of it.
